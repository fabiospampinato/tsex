...
export {DIR_DIST, DIR_SOURCE, DIR_TASK, DIR_TEST, NODE_MODULES, PATH_DIST, PATH_SOURCE, PATH_TASK, PATH_TEST, PATH_MODULES, PATH_ESBUILD, PATH_FAVA, PATH_PACKAGE, PATH_TSC, PATH_TSCONFIG};
